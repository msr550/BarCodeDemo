...
import com.msr.barcodedemo.camera.CameraSourcePreview;
import com.msr.barcodedemo.camera.GraphicOverlay;
...
public final class BarcodeTrackerActivity extends AppCompatActivity {
    ...
    private void createCameraSource() {
        ...
        mGraphicOverlay.setBarCodeDetectedListener(new BarcodeTrackerFactory.BarcodeDetectedListener() {
            @Override
